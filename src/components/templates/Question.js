            ...
            <div className='container-questions'>
                ...
                >
                    <AccordionSummary expandIcon={<ExpandMoreIcon />} aria-controls="panel1-content" id="panel1-header" >
                        <Typography component="span">کارت ویزیت هوشمند چیست؟</Typography>
                    </AccordionSummary>
                    <AccordionDetails>
                        <Typography>
                ...
                <Accordion>
                    <AccordionSummary
                        ...
                        id="panel2-header"
                    >
                        <Typography component="span">با خرید کارت ویزیت هوشمند چه امکاناتی دریافت میکنم؟</Typography>
                    </AccordionSummary>
                    <AccordionDetails>
                        <Typography>
                ...
                <Accordion>
                    <AccordionSummary
                        ...
                        id="panel2-header"
                    >
                        <Typography component="span">نیاز به نصب برنامه خاصی هست؟</Typography>
                    </AccordionSummary>
                    <AccordionDetails>
                        <Typography>
                ...
                <Accordion>
                    <AccordionSummary
                        ...
                        id="panel2-header"
                    >
                        <Typography component="span">خدمات فلت کارت پشتیبانی داره؟</Typography>
                    </AccordionSummary>
                    <AccordionDetails>
                        <Typography>
                ...
                <Accordion>
                    <AccordionSummary
                        ...
                        id="panel2-header"
                    >
                        <Typography component="span">چقد طول میکشه محصول دستمون برسه؟</Typography>
                    </AccordionSummary>
                    <AccordionDetails>
                        <Typography>
                ...
                <Accordion>
                    <AccordionSummary
                        ...
                        id="panel2-header"
                    >
                        <Typography component="span">میتونیم خودمون کارتمون رو طراحی کنیم؟</Typography>
                    </AccordionSummary>
                    <AccordionDetails>
                        <Typography>
                ...
                <Accordion>
                    <AccordionSummary
                        ...
                        id="panel2-header"
                    >
                        <Typography component="span">میتونیم اطلاعات پروفایل رو عوض کنیم؟</Typography>
                    </AccordionSummary>
                    <AccordionDetails>
                        <Typography>
                ...
                <Accordion>
                    <AccordionSummary
                        ...
                        id="panel2-header"
                    >
                        <Typography component="span">ارسال همه محصولات رایگان هست؟</Typography>
                    </AccordionSummary>
                    <AccordionDetails>
                        <Typography>
